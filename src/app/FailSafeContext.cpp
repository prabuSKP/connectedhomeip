...
void FailSafeContext::ScheduleFailSafeCleanup(FabricIndex fabricIndex, bool addNocCommandInvoked, bool updateNocCommandInvoked)
{
    ...
    event.FailSafeTimerExpired.updateTermsAndConditionsHasBeenInvoked     = UpdateTermsAndConditionsHasBeenInvoked();
    event.FailSafeTimerExpired.setVidVerificationStatementHasBeenInvoked  = HasSetVidVerificationStatementHasBeenInvoked();
